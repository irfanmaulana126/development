...
// $this->registerJs($this->render('vendor/jquery.min.js'),View::POS_HEAD);
// $this->registerCss($this->render('vendor/bootstrap.min.css'));
// $this->registerCss($this->render('vendor/prettify/prettify.css'));
// $this->registerCss($this->render('css/style.css'));
// $this->registerCss($this->render('fonts/glyphicons-halflings-regular.woff2'));
// $this->registerJs($this->render('vendor/polyfill.js'),View::POS_HEAD);
// $this->registerJs($this->render('vendor/bootstrap.min.js'),View::POS_HEAD);
// $this->registerJs($this->render('vendor/require.min.js'),View::POS_END);
// $dataScript=$this->registerJs($this->render('main.js'));


// $this->registerCssFile('http://development.kontrolgampang.com/template/api_local/vendor/bootstrap.min.css');
// $this->registerCssFile('http://development.kontrolgampang.com/template/api_local/vendor/prettify/prettify.css');
// $this->registerCssFile('http://development.kontrolgampang.com/template/api_local/css/style.css');
// $this->registerCssFile('http://development.kontrolgampang.com/template/api_local/fonts/glyphicons-halflings-regular.woff2');
// $this->registerJsFile('http://development.kontrolgampang.com/template/api_local/vendor/jquery.min.js',['position'=>POS_HEAD]);
// $this->registerJsFile('http://development.kontrolgampang.com/template/api_local/vendor/polyfill.js');
// $this->registerJsFile('http://development.kontrolgampang.com/template/api_local/vendor/bootstrap.min.js');
// $this->registerJsFile('http://development.kontrolgampang.com/template/api_local/vendor/require.min.js');
	//$dataScript=$this->registerJsFile('http://development.kontrolgampang.com/template/api_local/main.js');
?>
<!--<html>
<head>
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <title>Loading...</title>
  <link href="http://development.kontrolgampang.com/template/apidoc/vendor/bootstrap.min.css" rel="stylesheet" media="screen">
  <link href="http://development.kontrolgampang.com/template/apidoc/vendor/prettify.css" rel="stylesheet" media="screen">
  <link href="http://development.kontrolgampang.com/template/apidoc/css/style.css" rel="stylesheet" media="screen, print">
  <link href="img/favicon.ico" rel="icon" type="image/x-icon">
  <script src="http://development.kontrolgampang.com/template/apidoc/vendor/polyfill.js"></script>
  <script src="http://development.kontrolgampang.com/template/apidoc/vendor/jquery.min.js"></script>
</head>
<body>
!-->
