require.config({
    paths: {
        bootstrap: 'http://development.kontrolgampang.com/template/apidoc/vendor/bootstrap.min',
        diffMatchPatch: 'http://development.kontrolgampang.com/template/apidoc/vendor/diff_match_patch.min',
        handlebars: 'http://development.kontrolgampang.com/template/apidoc/vendor/handlebars.min',
        handlebarsExtended: 'http://development.kontrolgampang.com/template/apidoc/utils/handlebars_helper',
        jquery: 'http://development.kontrolgampang.com/template/apidoc/vendor/jquery.min',
        locales: 'http://development.kontrolgampang.com/template/apidoc/locales/locale',
        lodash: 'http://development.kontrolgampang.com/template/apidoc/vendor/lodash.custom.min',
        pathToRegexp: 'http://development.kontrolgampang.com/template/apidoc/vendor/path-to-regexp/index',
        prettify: 'http://development.kontrolgampang.com/template/apidoc/vendor/prettify/prettify',
        semver: 'http://development.kontrolgampang.com/template/apidoc/vendor/semver.min',
        utilsSampleRequest: 'http://development.kontrolgampang.com/template/apidoc/utils/send_sample_request',
        webfontloader: 'http://development.kontrolgampang.com/template/apidoc/vendor/webfontloader',
        list: 'http://development.kontrolgampang.com/template/apidoc/vendor/list.min'
    },
    shim: {
        bootstrap: {
            deps: ['jquery']
...
require([
    ...
    'locales',
    'handlebarsExtended',
    'http://development.kontrolgampang.com/template/apidoc/api_project.js',
    'http://development.kontrolgampang.com/template/apidoc/api_data.js',
    'prettify',
    'utilsSampleRequest',
    'semver',
    'webfontloader',
