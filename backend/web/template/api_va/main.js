require.config({
    paths: {
        bootstrap: 'https://development.kontrolgampang.com/template/api_va/vendor/bootstrap.min',
        diffMatchPatch: 'https://development.kontrolgampang.com/template/api_va/vendor/diff_match_patch.min',
        handlebars: 'https://development.kontrolgampang.com/template/api_va/vendor/handlebars.min',
        handlebarsExtended: 'https://development.kontrolgampang.com/template/api_va/utils/handlebars_helper',
        jquery: 'https://development.kontrolgampang.com/template/api_va/vendor/jquery.min',
        locales: 'https://development.kontrolgampang.com/template/api_va/locales/locale',
        lodash: 'https://development.kontrolgampang.com/template/api_va/vendor/lodash.custom.min',
        pathToRegexp: 'https://development.kontrolgampang.com/template/api_va/vendor/path-to-regexp/index',
        prettify: 'https://development.kontrolgampang.com/template/api_va/vendor/prettify/prettify',
        semver: 'https://development.kontrolgampang.com/template/api_va/vendor/semver.min',
        utilsSampleRequest: 'https://development.kontrolgampang.com/template/api_va/utils/send_sample_request',
        webfontloader: 'https://development.kontrolgampang.com/template/api_va/vendor/webfontloader',
        list: 'https://development.kontrolgampang.com/template/api_va/vendor/list.min'
    },
    shim: {
        bootstrap: {
            deps: ['jquery']
...
require([
    ...
    'locales',
    'handlebarsExtended',
    'https://development.kontrolgampang.com/template/api_va/api_project.js',
    'https://development.kontrolgampang.com/template/api_va/api_data.js',
    'prettify',
    'utilsSampleRequest',
    'semver',
    'webfontloader',
