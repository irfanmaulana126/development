require.config({
    paths: {
        bootstrap: 'http://development.kontrolgampang.com/template/api_va/vendor/bootstrap.min',
        diffMatchPatch: 'http://development.kontrolgampang.com/template/api_va/vendor/diff_match_patch.min',
        handlebars: 'http://development.kontrolgampang.com/template/api_va/vendor/handlebars.min',
        handlebarsExtended: 'http://development.kontrolgampang.com/template/api_va/utils/handlebars_helper',
        jquery: 'http://development.kontrolgampang.com/template/api_va/vendor/jquery.min',
        locales: 'http://development.kontrolgampang.com/template/api_va/locales/locale',
        lodash: 'http://development.kontrolgampang.com/template/api_va/vendor/lodash.custom.min',
        pathToRegexp: 'http://development.kontrolgampang.com/template/api_va/vendor/path-to-regexp/index',
        prettify: 'http://development.kontrolgampang.com/template/api_va/vendor/prettify/prettify',
        semver: 'http://development.kontrolgampang.com/template/api_va/vendor/semver.min',
        utilsSampleRequest: 'http://development.kontrolgampang.com/template/api_va/utils/send_sample_request',
        webfontloader: 'http://development.kontrolgampang.com/template/api_va/vendor/webfontloader',
        list: 'http://development.kontrolgampang.com/template/api_va/vendor/list.min'
    },
    shim: {
        bootstrap: {
            deps: ['jquery']
...
require([
    ...
    'locales',
    'handlebarsExtended',
    'http://development.kontrolgampang.com/template/api_va/api_project.js',
    'http://development.kontrolgampang.com/template/api_va/api_data.js',
    'prettify',
    'utilsSampleRequest',
    'semver',
    'webfontloader',
