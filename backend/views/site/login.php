...
<div class="row" style="text-align:center">
	...
	<div class="col-xs-12 col-sm-4 col-lg-4">
		<div class="col-xs-12 col-sm-12 col-lg-12 col-lg-12" style="text-align:center;margin-top:100px;" >	
		...
		<div class="col-xs-12 col-sm-12 col-lg-12 col-lg-12" style="text-align:center;margin-top:10px;margin-bottom:10px;"" >	
			<h4>DEVELOPMENT </h4>
		</div>
		<div class="row">
			 ...
			 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="form-group">
					<?php
						...
						])->passwordInput(['id'=>"	",'placeholder'=>'Password'])->label(false);
